...
export default function HolidayCalendarCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setHolidayDate(initialValues.holidayDate);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createHolidayCalendar.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HolidayCalendarCreateForm")}
      {...rest}
    >
      <TextField
        label="Holiday date"
